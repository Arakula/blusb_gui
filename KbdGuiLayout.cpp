...
static GuiKey AnsiM121[] =
  {
    ...
    { 0, 1, KB_F13,     0, 10, 1.00f, 1.00f, "F13", "F13" },
    { 0, 1, KB_F14,     1, 10, 1.00f, 1.00f, "F14", "F14" },
    { 0, 1, KB_F15,     1,  9, 1.00f, 1.00f, "F15", "F15" },
    { 0, 1, KB_F16,     2, 10, 1.00f, 1.00f, "F16", "F16" },
    { 0, 1, KB_F17,     3, 10, 1.00f, 1.00f, "F17", "F17" },
    { 0, 1, KB_F18,     3,  9, 1.00f, 1.00f, "F18", "F18" },
    { 0, 1, KB_F19,     4, 10, 1.00f, 1.00f, "F19", "F19" },
    { 0, 1, KB_F20,     5, 10, 1.00f, 1.00f, "F20", "F20" },
    { 0, 1, KB_F21,     5,  9, 1.00f, 1.00f, "F21", "F21" },
    { 0, 1, KB_F22,     6, 10, 1.00f, 1.00f, "F22", "F22" },
    { 0, 1, KB_F23,     7, 10, 1.00f, 1.00f, "F23", "F23" },
    { 0, 1, KB_F24,     7,  9, 1.00f, 1.00f, "F24", "F24" },
    // Row 1
    { 1, 1, -1,        -1, -1, 3.50f, 3.50f, "", "" },
    { 1, 1, KB_F1,      0,  9, 1.00f, 1.00f, "F1", "F1" },
    { 1, 1, KB_F2,      0,  8, 1.00f, 1.00f, "F2", "F2" },
    { 1, 1, KB_F3,      1,  8, 1.00f, 1.00f, "F3", "F3" },
    { 1, 1, KB_F4,      2,  9, 1.00f, 1.00f, "F4", "F4" },
    { 1, 1, KB_F5,      2,  8, 1.00f, 1.00f, "F5", "F5" },
    { 1, 1, KB_F6,      3,  8, 1.00f, 1.00f, "F6", "F6" },
    { 1, 1, KB_F7,      4,  9, 1.00f, 1.00f, "F7", "F7" },
    { 1, 1, KB_F8,      4,  8, 1.00f, 1.00f, "F8", "F8" },
    { 1, 1, KB_F9,      5,  8, 1.00f, 1.00f, "F9", "F5" },
    { 1, 1, KB_F10,     6,  9, 1.00f, 1.00f, "F10", "F10" },
    { 1, 1, KB_F11,     6,  8, 1.00f, 1.00f, "F11", "F11" },
    { 1, 1, KB_F12,     7,  8, 1.00f, 1.00f, "F12", "F12" },
    ...
    // Row 3
    { 3, 1, KB_ESC,     3, 18, 1.00f, 1.00f, "Esc", "Esc" },
    { 3, 1, KB_SCRLK,   3, 17, 1.00f, 1.00f, "Scroll\nLock", "Scroll Lock" },
    { 3, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 3, 1, KB_TILDE,   3, 15, 1.00f, 1.00f, "`~", "~" },
    { 3, 1, KB_1,       2, 15, 1.00f, 1.00f, "1 !", "1" },
    { 3, 1, KB_2,       2, 14, 1.00f, 1.00f, "2 @", "2" },
    { 3, 1, KB_3,       2, 13, 1.00f, 1.00f, "3 #", "3" },
    { 3, 1, KB_4,       2, 12, 1.00f, 1.00f, "4 $", "4" },
    { 3, 1, KB_5,       3, 12, 1.00f, 1.00f, "5 %", "5" },
    { 3, 1, KB_6,       3, 11, 1.00f, 1.00f, "6 ^", "6" },
    { 3, 1, KB_7,       2, 11, 1.00f, 1.00f, "7 &", "7" },
    { 3, 1, KB_8,       2,  7, 1.00f, 1.00f, "8 *", "8" },
    { 3, 1, KB_9,       2,  6, 1.00f, 1.00f, "9 (", "9" },
    { 3, 1, KB_0,       2,  5, 1.00f, 1.00f, "0 )", "0" },
    { 3, 1, KB_MINUS,   3,  5, 1.00f, 1.00f, "- _", "-" },
    { 3, 1, KB_EQUAL,   3,  7, 1.00f, 1.00f, "= +", "=" },
    { 3, 1, KB_BKSPC,   3,  4, 2.00f, 2.00f, "Backspace", "Backspace" },
    { 3, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 3, 1, KB_INS,     3,  3, 1.00f, 1.00f, "Insert", "Insert" },
    { 3, 1, KB_HOME,    3,  2, 1.00f, 1.00f, "Home", "Home" },
    { 3, 1, KB_PGUP,    2,  3, 1.00f, 1.00f, "Page\nUp", "Page Up" },
    { 3, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 3, 1, KB_END,     2,  4, 1.00f, 1.00f, "End", "End" },
    { 3, 1, KB_NUMLK,   2,  2, 1.00f, 1.00f, "Num\nLock", "Num Lock" },
    { 3, 1, KP_SLASH,   2,  1, 1.00f, 1.00f, "/", "Num /" },
    { 3, 1, KP_ASTRX,   2, 19, 1.00f, 1.00f, "*", "Num *" },
    // Row 4
    { 4, 1, KB_PSCRN,   2, 18, 1.00f, 1.00f, "Print\nScrn", "Print Screen" },
    { 4, 1, KB_PAUSE,   4, 18, 1.00f, 1.00f, "Pause", "Pause" },
    { 4, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 4, 1, KB_TAB,     4, 17, 1.50f, 1.50f, "Tab", "Tab" },
    { 4, 1, KB_Q,       4, 15, 1.00f, 1.00f, "Q", "Q" },
    { 4, 1, KB_W,       4, 14, 1.00f, 1.00f, "W", "W" },
    { 4, 1, KB_E,       4, 13, 1.00f, 1.00f, "E", "E" },
    { 4, 1, KB_R,       4, 12, 1.00f, 1.00f, "R", "R" },
    { 4, 1, KB_T,       5, 12, 1.00f, 1.00f, "T", "T" },
    { 4, 1, KB_Y,       5, 11, 1.00f, 1.00f, "Y", "Y" },
    { 4, 1, KB_U,       4, 11, 1.00f, 1.00f, "U", "U" },
    { 4, 1, KB_I,       4,  7, 1.00f, 1.00f, "I", "I" },
    { 4, 1, KB_O,       4,  6, 1.00f, 1.00f, "O", "O" },
    { 4, 1, KB_P,       4,  5, 1.00f, 1.00f, "P", "P" },
    { 4, 1, KB_LBRCE,   5,  5, 1.00f, 1.00f, "[ {", "[" },
    { 4, 1, KB_RBRCE,   5,  7, 1.00f, 1.00f, "] }", "]" },
    { 4, 1, KB_BSLSH,   4,  4, 1.50f, 1.50f, "\\ |", "\\" },
    { 4, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 4, 1, KB_DEL,     1,  3, 1.00f, 1.00f, "Delete", "Delete" },
    { 4, 1, KB_END,     5,  3, 1.00f, 1.00f, "End", "End" },
    { 4, 1, KB_PGDN,    4,  3, 1.00f, 1.00f, "Page\nDown", "Page Down" },
    { 4, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 4, 1, KP_7,       4,  4, 1.00f, 1.00f, "7", "Num 7" },
    { 4, 1, KP_8,       4,  2, 1.00f, 1.00f, "8", "Num 8" },
    { 4, 1, KP_9,       4,  1, 1.00f, 1.00f, "9", "Num 9" },
    { 4, 1, KP_MINUS,   4, 19, 1.00f, 1.00f, "-", "Num -" },
    // Row 5
    { 5, 1, KB_NONE,    5, 18, 1.00f, 1.00f, "EF5", "EF5" },
    { 5, 1, KB_NONE,    5, 17, 1.00f, 1.00f, "EF6", "EF6" },
    { 5, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 5, 1, KB_CAPLK,   6, 17, 1.75f, 1.75f, "Caps Lock", "Caps Lock" },
    { 5, 1, KB_A,       1, 15, 1.00f, 1.00f, "A", "A" },
    { 5, 1, KB_S,       1, 14, 1.00f, 1.00f, "S", "S" },
    { 5, 1, KB_D,       1, 13, 1.00f, 1.00f, "D", "D" },
    { 5, 1, KB_F,       1, 12, 1.00f, 1.00f, "F", "F" },
    { 5, 1, KB_G,       0, 12, 1.00f, 1.00f, "G", "G" },
    { 5, 1, KB_H,       0, 11, 1.00f, 1.00f, "H", "H" },
    { 5, 1, KB_J,       1, 11, 1.00f, 1.00f, "J", "J" },
    { 5, 1, KB_K,       1,  7, 1.00f, 1.00f, "K", "K" },
    { 5, 1, KB_L,       1,  6, 1.00f, 1.00f, "L", "L" },
    { 5, 1, KB_SMCLN,   1,  5, 1.00f, 1.00f, "; :", ";" },
    { 5, 1, KB_QUOTE,   0,  5, 1.00f, 1.00f, "' \"", "'" },
    { 5, 1, KB_ENTER,   6,  4, 2.25f, 2.25f, "Enter", "Enter" },
    { 5, 1, -1,        -1, -1, 1.50f, 1.50f, "", "" },
    { 5, 1, KB_UP,      0,  3, 1.00f, 1.00f, "Up", "Up" },
    { 5, 1, -1,        -1, -1, 1.50f, 1.50f, "", "" },
    { 5, 1, KP_4,       1,  4, 1.00f, 1.00f, "4", "Num 4" },
    { 5, 1, KP_5,       1,  2, 1.00f, 1.00f, "5", "Num 5" },
    { 5, 1, KP_6,       1,  1, 1.00f, 1.00f, "6", "Num 6" },
    { 5, 1, KP_PLUS,    4, 19, 1.00f, 1.00f, "+", "Num +" },
    // Row 6
    { 6, 1, KB_NONE,    1, 18, 1.00f, 1.00f, "EF7", "EF7" },
    { 6, 1, KB_NONE,    1, 17, 1.00f, 1.00f, "EF8", "EF8" },
    { 6, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 6, 1, KB_LSHFT,   7, 16, 2.25f, 2.25f, "Shift", "LShift" },
    { 6, 1, KB_Z,       6, 15, 1.00f, 1.00f, "Z", "Z" },
    { 6, 1, KB_X,       6, 14, 1.00f, 1.00f, "X", "X" },
    { 6, 1, KB_C,       6, 13, 1.00f, 1.00f, "C", "C" },
    { 6, 1, KB_V,       6, 12, 1.00f, 1.00f, "V", "V" },
    { 6, 1, KB_B,       7, 12, 1.00f, 1.00f, "B", "B" },
    { 6, 1, KB_N,       7, 11, 1.00f, 1.00f, "N", "N" },
    { 6, 1, KB_M,       6, 11, 1.00f, 1.00f, "M", "M" },
    { 6, 1, KB_COMMA,   6,  7, 1.00f, 1.00f, ", <", "," },
    { 6, 1, KB_DOT,     6,  6, 1.00f, 1.00f, ". >", "." },
    { 6, 1, KB_SLASH,   7,  5, 1.00f, 1.00f, "/ ?", "/" },
    { 6, 1, KB_RSHFT,   6, 16, 2.75f, 2.75f, "Shift", "RShift" },
    { 6, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 6, 1, KB_LEFT,    6, 19, 1.00f, 1.00f, "Left", "Left" },
    { 6, 1, KB_HOME,    0,  0, 1.00f, 1.00f, "Home", "Home" },
    { 6, 1, KB_RIGHT,   1,  0, 1.00f, 1.00f, "Right", "Right" },
    { 6, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 6, 1, KP_1,       6, 18, 1.00f, 1.00f, "1", "1" },
    { 6, 1, KP_2,       6,  2, 1.00f, 1.00f, "2", "2" },
    { 6, 1, KP_3,       6,  1, 1.00f, 1.00f, "3", "3" },
    { 6, 2, KP_ENTER,   7,  0, 1.00f, 1.00f, "Enter", "Enter" },
    // Row 7
    { 7, 1, KB_LGUI,    0, 17, 1.00f, 1.00f, "Win", "LWin" },
    { 7, 1, KB_APP,     0, 18, 1.00f, 1.00f, "Menu", "Menu" },
    { 7, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 7, 1, KB_LCTRL,   0, 19, 1.50f, 1.50f, "Ctrl", "LCtrl" },
    { 7, 1, -1,        -1, -1, 1.00f, 1.00f, "", "" },
    { 7, 1, KB_LALT,    7, 19, 1.50f, 1.50f, "Alt", "LAlt" },
    { 7, 1, KB_SPACE,   7, 18, 7.00f, 7.00f, "Space", "Space" },
    { 7, 1, KB_RALT,    0, 15, 1.50f, 1.50f, "AltGr", "RAlt" },
    { 7, 1, -1,        -1, -1, 1.00f, 1.00f, "", "" },
    { 7, 1, KB_RCTRL,   7, 17, 1.50f, 1.50f, "Ctrl", "RCtrl" },
    { 7, 1, -1,        -1, -1, 1.50f, 1.50f, "", "" },
    { 7, 1, KB_DOWN,    0,  4, 1.00f, 1.00f, "Down", "Down" },
    { 7, 1, -1,        -1, -1, 1.50f, 1.50f, "", "" },
    { 7, 1, KP_0,       7,  2, 2.00f, 2.00f, "0", "0" },
    { 7, 1, KP_DOT,     7,  1, 1.00f, 1.00f, ".", "." },
...
static GuiKey IsoM122[] =
  {
    ...
    { 4, 1, KB_LBRCE,   5,  5, 1.00f, 1.00f, "[ {", "[" },
    { 4, 1, KB_RBRCE,   5,  7, 1.00f, 1.00f, "] }", "]" },
    { 4, 2, KB_ENTER,   6,  4, 1.50f, 1.25f, "Enter", "Enter" },
    { 4, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 4, 1, KB_DEL,     1,  3, 1.00f, 1.00f, "Delete", "Delete" },
    { 4, 1, KB_END,     5,  3, 1.00f, 1.00f, "End", "End" },
    { 4, 1, KB_PGDN,    4,  3, 1.00f, 1.00f, "Page\nDown", "Page Down" },
    ...
    { 6, 1, KB_NONE,    1, 17, 1.00f, 1.00f, "EF8", "EF8" },
    { 6, 1, -1,        -1, -1, 0.50f, 0.50f, "", "" },
    { 6, 1, KB_LSHFT,   7, 16, 1.25f, 1.25f, "Shift", "LShift" },
    { 6, 1, KB_PIPE,    7, 15, 1.00f, 1.00f, "\\ |", "\\" },
    { 6, 1, KB_Z,       6, 15, 1.00f, 1.00f, "Z", "Z" },
    { 6, 1, KB_X,       6, 14, 1.00f, 1.00f, "X", "X" },
    { 6, 1, KB_C,       6, 13, 1.00f, 1.00f, "C", "C" },
    { 6, 1, KB_V,       6, 12, 1.00f, 1.00f, "V", "V" },
